...
#training the model
support_vector = svm.SVC(kernel='linear', probability=True)
...
print("Classification report for - \n{}:\n{}\n".format(
    support_vector, metrics.classification_report(y_test, y_pred, target_names = types)))


# In[19]:


probabilities = support_vector.predict_proba(x_test)
